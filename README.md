...
| All programs / Compare | Filter all 17 federal programs; compare up to three side by side |
...
| **Visas & Immigration** | O-1A, EB-1A, EB-2 NIW, International Entrepreneur Parole, E-2, L-1A — with eligibility, tradeoffs, and official USCIS/State Dept. sources |
...
| Area | India | USA |
| --- | --- | --- |
| Central schemes | 69 India-specific schemes tied to DPIIT recognition | 17 federal programs (SBA loans, SBIR/STTR, EDA, NSF I-Corps, R&D tax credit, QSBS, Opportunity Zones, USPTO fee reductions, EXIM, MBDA, SBIC, DOE, USDA) |
...
| Incubators | 220+ Technology Business Incubators / Atal Incubation Centres | SBA Small Business Development Centers, NSF I-Corps hubs, and major accelerators (Y Combinator, Techstars, MassChallenge, gener8tor, and 30+ verified state-specific programs) |
...
- **Design change**? Edit `site/tokens.css` (palette/fonts, civic navy + teal + green — deliberately not a flag-color palette) or `site/site.css` (components), rebuild.
